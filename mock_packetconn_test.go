...
//
//	mockgen -typed -package quic -self_package github.com/munew/tlsclient-quic-go -self_package github.com/munew/tlsclient-quic-go -destination mock_packetconn_test.go net PacketConn
//
